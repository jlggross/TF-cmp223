...
%----------------------------------------------------------------------------------
\section{Hardware e Ambiente}
[TODO]
Citar características/configuração do hardware
Local de instalação: Data Center TJRS - acesso ao hardware 24-7, climatização no Data Center
Ambiente: SO Ubuntu (ver versão)
Configuração vPRO, acesso RDP
...
%----------------------------------------------------------------------------------
\section{Características dos scripts e cenários de teste}
