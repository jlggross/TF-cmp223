...
\subsubsection{Evolução da Temperatura}
Gráfico com evolução da temperatura da CPU para mostrar que houve estabilidade da temperatura no tempo
Mostrar 3 gráficos, isto é, um para cada implementação
